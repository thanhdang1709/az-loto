...
import { useGetAzwBalance, useGetCakeBalance } from 'hooks/useTokenBalance'
...
const EventStepsSection: React.FC<EventStepsProps> = ({ eventInfos, userInfos, isLoading, userStatus, account }) => {
  ...
  const { balance: azwBalance } = useGetAzwBalance()
  const stepsConfig = stepsConfigBuilder({ t, eventInfos, userInfos, userStatus, account, theme, azwBalance })
