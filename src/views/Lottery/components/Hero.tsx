...
const StyledBuyTicketButton = styled(BuyTicketsButton)<{ disabled: boolean }>`
  background: ${({ theme, disabled }) => (disabled ? theme.colors.disabled : theme.colors.gradients.purpleAqua)};
  width: 200px;
...
const Hero = () => {
  ...
  const prizeInBusd = amountCollectedInCake.times(azwBusdPrice)
  const prizeTotal = getBalanceNumber(prizeInBusd, 5)
  ...
  return (
    <Flex flexDirection="column" alignItems="center" justifyContent="center">
      ...
      <Heading mb="8px" scale="md" color="#ffffff" id="lottery-hero-title" >
        {t('The AZ World Network Lottery')}
      </Heading>
      {getHeroHeading()}
      <TicketContainer
        position="relative"
