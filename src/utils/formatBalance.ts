 ...
 */
export const getDecimalAmount = (amount: BigNumber, decimals = 5) => {
  return new BigNumber(amount).times(getFullDecimalMultiplier(decimals))
}

export const getBalanceAmount = (amount: BigNumber, decimals = 5) => {
 ...
 */
export const getBalanceNumber = (balance: BigNumber, decimals = 5) => {
  return getBalanceAmount(balance, decimals).toNumber()
}

export const getFullDisplayBalance = (balance: BigNumber, decimals = 5, displayDecimals?: number): string => {
